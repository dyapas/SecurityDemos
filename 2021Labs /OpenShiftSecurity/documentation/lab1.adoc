...
. Create a new project called *user-XX-project*.
+
[source]
----
[localhost ~]$ oc new-project user-XX-project
----

. In the OpenShift console, navigate to *Home->Projects*, search for *user-XX-project* and click on it.
+
...
. Now, go back to your terminal and go into the project you just created by typing *oc project user-XX-project*. Then, take a look at your pods by typing *oc get pods*. Notice that one of your pods has a CrashLoopBackOff error.
+
